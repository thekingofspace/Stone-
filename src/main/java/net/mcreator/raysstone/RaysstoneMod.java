 ...
 *
 */
package net.mcreator.raysstone;
...
@Mod("raysstone")
public class RaysstoneMod {
	public static final Logger LOGGER = LogManager.getLogger(RaysstoneMod.class);
	public static final String MODID = "raysstone";
